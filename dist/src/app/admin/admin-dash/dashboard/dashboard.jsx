...
const Dashboard = () => {
    ...
    return (<div className="p-6 ml-10">
      <h1 className="text-2xl font-bold mb-4">Dashboard</h1>
      <div className="flex flex-wrap gap-4 mb-6">
        {orderStatuses.map((status) => (<div key={status.label} className={`${status.bgColor} text-black p-4 rounded-md shadow-md w-40 h-20 text-center `}>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white shadow-md rounded-lg">
          ...
          <tbody className="text-gray-600 text-sm font-light">
            {orders.map((order) => (<tr key={order.orderNumber} className="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td className="py-3 px-6 text-left">
                  <link_1.default href={`/admin/admin-dash/detail`}>
